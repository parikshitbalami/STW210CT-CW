...
public class HighRisk extends JFrame implements MouseListener {
	...
	public static void main(String[] args) {
		HighRisk frame = new HighRisk(adjacency_matrix);
		frame.setVisible(true);
	}


	public HighRisk(int[][] matrix) {
